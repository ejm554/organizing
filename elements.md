...
| [Systainer](../element-pages/systainer.md)<br>Modular inter-stacking plastic containers<br>used for transporting power tools.<br>Boxes from different manufacturers are<br>compatible and can be stacked and clipped together. | ![Systainer containers from multiple manufacturers](<https://upload.wikimedia.org/wikipedia/commons/thumb/3/31/Systainer-classic-makpac-festool-sys-mft-metaloc-t-loc-toolbox.jpg/1280px-Systainer-classic-makpac-festool-sys-mft-metaloc-t-loc-toolbox.jpg>) |
